...
import shibu from '../assets/shibu.jpeg';
import iyer from '../assets/iyer.jpeg';
...
const boardMembers = [
  ...
  },
  {
    ...
    title: "Regional Manager – Seahorse Group",
    description: `Mr. Prakash Iyer
Regional Manager – Seahorse Group
    ...
    <div className="mb-4 flex items-start gap-4">
      <div className="h-16 w-16 overflow-hidden rounded-full border border-slate-200 bg-slate-50">
        {member.imageSrc ? (
          <img
            src={member.imageSrc}
            alt={normalizeCopy(member.name)}
            className="h-full w-full object-contain object-center bg-white p-1"
          />
        ) : (
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto space-y-24">
          <section className="relative">
            <div className="flex flex-col items-start gap-6 rounded-3xl border border-blue-100 bg-blue-50 p-6 sm:p-8 md:flex-row md:items-start md:gap-8">
              <div className="bg-blue-600 text-white p-4 rounded-2xl shadow-lg shrink-0">
                <Building2 size={32} />
              </div>
              <div className="flex-1 space-y-4 text-left text-base font-semibold leading-8 text-gray-700 md:text-lg">
                <p className="text-justify">
                  MARPORTS GLOBAL Conference & Excellence Awards is a premier international platform that brings together maritime leaders, shipowners, port developers, terminal operators, ship designers and builders, digitalization experts, policymakers, and industry visionaries from across the globe.
                </p>
                <p className="text-justify">
                  Dedicated to shaping the future of the maritime and port ecosystem, MARPORTS GLOBAL convenes some of the industry’s most influential voices to exchange insights, explore emerging innovations, and celebrate excellence. From thought-provoking sessions on green shipping, advanced ship design and shipbuilding, port ecosystems, digital transformation, and decarbonization, to recognizing pioneers redefining maritime leadership, MARPORTS GLOBAL serves as a catalyst for the future of global ocean trade.
                </p>
                <p className="text-justify">
                  Invited speakers and panellists can engage with a diverse range of cutting-edge topics, contributing to meaningful dialogue and industry advancement.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="bg-white p-8 md:p-12 rounded-3xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow mb-12">
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-4">
              <p>
                E Hub Events Pvt. Ltd. is a dynamic and visionary event management company committed to creating world-class platforms that inspire, connect, and elevate industries. 
              </p>
              <p>
                With a strong foundation built on global exposure, strategic networking, and execution excellence, we specialize in curating high-impact conferences and prestigious awards that leave a lasting impression.

              </p>
              <p>
            We are the proud creators of the MARPORTS GLOBAL Conference & Excellence Awards—a premier international maritime platform designed as an annual convergence of global industry leaders, innovators, and policymakers. MARPORTS GLOBAL is more than just an event; it is a powerful initiative aimed at shaping the future of the maritime ecosystem while fostering collaboration, innovation, and excellence on a global scale.
 </p>
              <p>
He was also the visionary behind SHIPTEK, a globally recognized maritime event that expanded from India to key international destinations including the UAE, Singapore, Saudi Arabia, Greece, and Hong Kong—earning its reputation as one of the most respected maritime networking platforms originating from India.
              </p>
              <p>
                With MARPORTS GLOBAL, E Hub Events is ushering in a new era—positioning Thiruvananthapuram as an emerging maritime hub in the Indian Ocean region and establishing a prestigious annual gathering that celebrates leadership, innovation, and excellence.

                             </p>
              <p>At our core, we stand for credibility, quality, global reach, and long-term industry impact.
E Hub Events Pvt. Ltd. is not just building events—we are building legacies.</p>
              <p className="font-semibold text-gray-900">Marports Global is not just a conference ” it is the beginning of an enduring maritime legacy.</p>
            </div>
          </div>
        </div>
      </div>
